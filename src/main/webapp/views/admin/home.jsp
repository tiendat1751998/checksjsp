...
<script>
    $(document).ready(function () {
        ...
        $('#pagination').twbsPagination({
            ...
            visiblePages: 5, // Số lượng trang hiển thị cùng lúc
            first: '«',      // Ký hiệu trang đầu tiên
            prev: '‹',       // Ký hiệu trang trước
            next: '›',       // Ký hiệu trang tiếp theo
            last: '»',       // Ký hiệu trang cuối
            onPageClick: function (event, page) {
                loadData(page);
            }
        });

        // Hàm tải dữ liệu khi chuyển trang
        function loadData(page) {
            $('#content').html('<b>Đang tải dữ liệu cho trang ' + page + '...</b>');
            setTimeout(function () {
                $('#content').html('<b>Nội dung hiển thị cho trang ' + page + '</b>');
